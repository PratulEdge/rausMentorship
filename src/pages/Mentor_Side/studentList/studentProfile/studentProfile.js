                                        ...
                                        <div className="p-2">
                                            ...
                                            <div className="hstack text-white-50 gap-1">
                                                <div className="me-2"><i
                                                    className="ri-map-pin-user-line me-1 text-white-75 fs-16 align-middle">{stu_val.address_2_line_1},{stu_val.address_2_line_2}</i></div>
                                                <div><i
                                                    className="ri-building-line me-1 text-white-75 fs-16 align-middle"></i>ID:- {stu_val.student_id}
                                                </div>
                                            </div>
                                        </div>
                                    </Col>
                                        ...
                                        <div className="d-flex">
                                            <Nav pills className="animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1"
                                                ...
                                                <NavItem>
                                                    ...
                                                    >
                                                        <i className="ri-list-unordered d-inline-block d-md-none"></i> <span
                                                            className="d-none d-md-inline-block">Test Reports</span>
                                                    </NavLink>
                                                </NavItem>
                                            </Nav>
                                        </div>
...
export default Ms_StudentProfile;