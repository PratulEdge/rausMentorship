                    ...
                    },
                    {
                        ...
                        formatter: (cell) => _(<UncontrolledDropdown className="dropdown d-inline-block">
                            ...
                            <DropdownMenu className="dropdown-menu-end">
                                <DropdownItem href={`/student-test-series/${cell}`}><i className="ri-eye-fill align-bottom me-2 text-muted"></i>View</DropdownItem>
                            </DropdownMenu>
