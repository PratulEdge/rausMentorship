...
import { Button, Card, CardBody, CardHeader, Col, Container, ListGroup, ListGroupItem, Modal, ModalBody, ModalFooter, ModalHeader, Row, Form, Label } from 'reactstrap';
import { useSelector, useDispatch } from "react-redux";
import { Link, useParams } from 'react-router-dom';
import * as Yup from "yup";
import { useFormik, yupToFormErrors } from "formik";
import { mentorSession } from '../../../../store/actions';
...
const MentorProfileSessionData = () => {
    ...
    const { assignedSession } = useSelector((state) => ({
        assignedSession: state.MentorAssignedSessionData.assignedSession,
    }));
...
export { MentorProfileSessionData };