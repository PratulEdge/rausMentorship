...
const StudentAssignedSessionData = (state = INIT_STATE, action) => {
    console.log(action.type, "in here 1")
    switch (action.type) {
        case STUDENT_ASSIGNED_SESSION_SUCCESS:
            console.log("in here 2")
            switch (action.payload.actionType) {
                case STUDENT_ASSIGNED_SESSION:
        ...
        case STUDENT_ASSIGNED_SESSION_API_ERROR:
            switch (action.payload.actionType) {
                case STUDENT_ASSIGNED_SESSION:
                    return {
                        ...state,
...
export default StudentAssignedSessionData;