...
//new Import
import MentorList from "../pages/Admin_Mentor/MentorList/MentorList";
import StudentList from "../pages/Admin_Mentor/StudentList/StudentList";
import OtpAuth from "../pages/Authentication/Otp";
import MentorAvailibility from "../pages/Admin_Mentor/MentorAvailibility/mentorAvailibility";
import SuccessMessage from "../pages/Admin_Mentor/AlertMessages/sucess";
import MentorUpComing from "../pages/Admin_Mentor/MentorUpComing/MentorUpComing";
import UpComingSession from "../pages/Admin_Mentor/MentorUpComing/UpComingSession";
// import Sessions from "../pages/Admin_Mentor/MentorUpComing/sessions";
// import StudentUpComingSession from "../pages/Admin_Mentor/StudentUpComing/StudentUpComingSession";
import MentorProfile from "../pages/Admin_Mentor/MentorProfile/MentorProfile";
import EditMentorProfile from "../pages/Admin_Mentor/MentorProfile/EditMentorProfile";
import SessionList from "../pages/Admin_Mentor/SessionList/SessionList";
import StudentProfile from "../pages/Admin_Mentor/student/StudentProfile/studentProfile";
import SessionDetail from "../pages/Admin_Mentor/SessionList/SessionDetail/SessionDetail";
import CreateMentor from "../pages/Admin_Mentor/MentorList/CreateMentor";
import DashboardEcommerceMentor from "../pages/DashboardEcommerceMentor";
// import DeteleSession from "../pages/Admin_Mentor/SessionList/deleteSession/deleteSession";
// import CreateMentor from "../pages/Admin_Mentor/MentorList/CreateMentor";

//Mentor Side

import MentorDashboard from "../pages/Mentor_Side/Dashboard";
import Ms_StudentList from "../pages/Mentor_Side/studentList/StudentList";
import Ms_UpComing_Sessions from "../pages/Mentor_Side/UpComingSessions/Ms_UpComing_sessions";
import Past_Session from "../pages/Mentor_Side/Dashboard/pastSession/Past_session";
...
import StudentDashboard from "../pages/studentSide/Dashboard";
...
const authProtectedRoutes = user_type === '2' ? [
  ...
  //new Paths
  // {path: "/dashbaord-mentor", component: DashboardEcommerceMentor},
  { path: "/dashboard", component: DashboardEcommerce },
  { path: "/index", component: DashboardEcommerce },
  {path: "/session-details/:id", component:SessionDetail},
  { path: "/mentor-list", component: MentorList },
  {path: "/student-list", component: StudentList},
  {path: "/mentor-avail", component: MentorAvailibility},
  {path: "/sucess-message", component: SuccessMessage},
  // {path: "/upcoming-session", component: MentorUpComing},
  {path: "/upcoming-sessions", component: UpComingSession},
  // {path: "/current-sessions", component: Sessions},
  // {path: "/student-upcoming-sessions", component:StudentUpComingSession },
  {path: "/mentor-profile-view/:id", component:MentorProfile},
  {path: "/edit-mentor-profile/:id", component:EditMentorProfile },
  {path: "/session-list", component:SessionList},
  {path: "/student-profile/:id", component:StudentProfile},
  {path:"/create-mentor", component:CreateMentor},
  ...
  {path:"/mentor-dashboard", component:MentorDashboard},
  {path:"/student-details", component:Ms_StudentList},
  {path: "/session-list", component:SessionList},
  {path: '/upcoming-sessions',component:Ms_UpComing_Sessions},
  {path: '/past-sessions', component:Past_Session},
  ...
  {path: '/ms_mentor_availability',component:Ms_MentorAvailibility},
  {
    path: "/",
    exact: true,
    component: () => <Redirect to="/mentor-dashboard" />,
  },
  // {
  //   path: "/*",
  //   exact: true,
